...
icd_df = pd.read_excel('../data/国际疾病分类ICD-10北京临床版v601.xlsx', header=None, names=['icd_code', 'name'])
out_data = []
with open('../data/CHIP-CDN-train.json', encoding='utf-8') as df:
...
train, dev = train_test_split(out_data, test_size=0.2, random_state=42)
